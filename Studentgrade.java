...
public class StudentGrade {
	public static void main(String[] args){
        ...
        public void studentTable() {
            ...
            StudentGrade maxValue = myStudents.stream().max(Comparator.comparing(Student::getFirstSub)).get();
            System.out.println(maxValue.studentName + " Scoring " + maxValue.subject1);

            System.out.print("Lowest scoring student is: ");
            StudentGrade minValue = myStudents.stream().min(Comparator.comparing(Student::getFirstSub)).get();
